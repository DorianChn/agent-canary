...
测试期间只公开发布 V1；当前 0.x 过渡版本仍可免费使用。V2 及以后版本
不作为公开下载发布；如果需要新版本、私有集成或定制支持，请联系作者洽谈合作。

## 支持项目 / 合作联系

V1 是测试期公开版本，可免费使用。赞助用于支持项目维护，不会自动授予
未公开版本。
如果需要 V2+、私有集成或定制支持，请通过
[Discussions](https://github.com/DorianChn/agent-canary/discussions) 联系作者洽谈合作；不要公开提交付款凭证、密钥或其他隐私信息。

已获得合作授权时，先配置赞助网关再激活。随附本地网关默认地址为
`http://127.0.0.1:8787`：
